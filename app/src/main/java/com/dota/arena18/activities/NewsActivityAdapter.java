...
public class NewsActivityAdapter extends RecyclerView.Adapter<customviewholder>{
    ...
    public customviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_news_content,null, false);
